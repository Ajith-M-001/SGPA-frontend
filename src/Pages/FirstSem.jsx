...
const FirstSem = () => {
  ...
  const sendCalculatedData = async (
    ...
    try {
      const URL = "https://sgpacalculatorbackend.onrender.com/api/1stsem"; // Replace with your actual backend URL
              ...
              <div className="grid grid-cols-4 md:grid-cols-6 sm:grid-cols-6 lg:grid-cols-6 gap-4 second_field">
                <div className="mb-6">
                  ...
                  >
                    ...
                    <option value="20MCA11" data-credit="4">
                      20MCA11 (DSA)
                    </option>
                    <option value="20MCA12" data-credit="4">
                      20MCA12 (OS & UNIX)
                    </option>
                    <option value="20MCA13" data-credit="4">
                      20MCA13 (CN)
                    </option>
                    <option value="20MCA14" data-credit="4">
                      20MCA14 (MFCA)
                    </option>
                    <option value="20MCA15" data-credit="2">
                      20MCA15 (RM)
                    </option>
                    <option value="20MCA16" data-credit="2">
                      20MCA16 (DSA LAB)
                    </option>
                    <option value="20MCA17" data-credit="2">
                      20MCA17 (UNIX LAB)
                    </option>
                    <option value="20MCA18" data-credit="2">
                      20MCA18 (CN LAB)
                    </option>
                  </select>
                  <div className="error-container h-10 w-35">
